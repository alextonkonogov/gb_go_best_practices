...
import (
	...
	"github.com/alextonkonogov/gb_go_best_practices/homework3/pkg/files"
	"github.com/alextonkonogov/gb_go_best_practices/homework3/pkg/program"
)
...
func Example() {
	...
	program := program.NewProgram(cnfg, uniqueFiles, uniqueFiles, uniqueFiles, uniqueFiles, log)
	err = program.Start()
	if err != nil {
		log.Fatal(err)
	}
